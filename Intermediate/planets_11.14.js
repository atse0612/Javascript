...
}); // setting the filters between the required asks for its temperature and distance

console.log(habitablePlanets); //getting the names of the planets that meet the requirements